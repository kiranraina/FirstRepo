...
public:
     void print();
     template<typename z>friend class PMSLL;
//private:
     T *m_x;
    Node<T> *m_nextAdd;
...
PMSLL<T>::PMSLL()
{
cout<<"PMSLL constructor called"<<endl;
 m_head=nullptr;
}
template<typename T>
PMSLL<T>::~PMSLL()
{
    cout<<"PMSLL Destructor called"<<endl;
}
//template<typename T>
//bool PMSLL<T>::Add(T arg){
