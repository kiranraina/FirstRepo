...
//PatientMonitorSystem *PatientMonitorSystem::getSelf()
//{
//    if(self==nullptr)
//    return self;
//}

//void PatientMonitorSystem::setSelf(PatientMonitorSystem *value)
//{
//    self = value;
//}
...
//     this->inputPersonDetails();
    this->initECGHardware();
//    this->initECGForPerson();
    return true;
}
